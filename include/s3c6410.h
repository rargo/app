...
/* for external interrupt group 0 */
#define EINTCON0			0x900
#define EINTCON1			0x904
#define EINTFLTCON0			0x910
#define EINTFLTCON1			0x914
#define EINTFLTCON2			0x918
#define EINTFLTCON3			0x91c
#define EINTMASK			0x920
#define EINTPEND		0x924

#define EINTCON0_REG			__REG(ELFIN_GPIO_BASE+EINTCON0)
#define EINTCON1_REG			__REG(ELFIN_GPIO_BASE+EINTCON1)
#define EINTFLTCON0_REG			__REG(ELFIN_GPIO_BASE+EINTFLTCON0)
#define EINTFLTCON1_REG			__REG(ELFIN_GPIO_BASE+EINTFLTCON1)
#define EINTFLTCON2_REG			__REG(ELFIN_GPIO_BASE+EINTFLTCON2)
#define EINTFLTCON3_REG			__REG(ELFIN_GPIO_BASE+EINTFLTCON3)
#define EINTMASK_REG			__REG(ELFIN_GPIO_BASE+EINTMASK)
#define EINTPEND_REG		__REG(ELFIN_GPIO_BASE+EINTPEND)
